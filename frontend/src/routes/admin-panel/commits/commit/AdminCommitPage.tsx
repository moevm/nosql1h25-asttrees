...
import {
    $adminBranch,
    $adminBranchId, $adminCommit, $adminCommitId,
    type ApiEntityBranchModel, type ApiEntityCommitModel
} from "@/store/store.ts";
            ...
            <div className="flex flex-col gap-2">
                ...
                <EntityCard
                    items={[
                        ...
                        ['Дата создания репозитория', <DateRenderer value={dayjs(props.data.repository?.createdAt)}/>],
